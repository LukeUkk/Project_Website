<?php
   include('session.php'); 
 $user="SELECT Username FROM logins WHERE Username = 'Admin'"; 
?>
<!doctype html>
<html lang="en">
  <head>
    <title>Vista Chalet Hire</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <header class="site-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-4 site-logo" data-aos="fade"><a href="indexx.php"><em>Vista Chalet Hire</em></a></div> <!--added this-->
          <div class="col-8">
                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-6">
                      <ul class="list-unstyled menu">
                        ...
                        <li><a href="hotel.html">Chalets</a></li>
                        <li><a href="about.html">About</a></li>
                        <li><a href="blog.html">Blog</a></li>
                        <li><a href="contact.html">Contact</a></li>
						<li><a href="logout.php">Sign Out</a></li> <!--added this-->
						<?php if($login_session=='Admin'){ ?> <li><a href="admin.html">Admin</a></li> <?php } ?><!--added this-->
                      </ul>
                    </div>
      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center">
            <h1 class="heading" data-aos="fade-up">Welcome to <em>Vista Chalet Hire</em> <?php echo $login_session; ?></h1><!--added this-->
            <p class="sub-heading mb-5" data-aos="fade-up" data-aos-delay="100">Discover our world-class chalet's &amp; attractions.</p>
            <p data-aos="fade-up" data-aos-delay="100"><a href="hotel.html" class="btn uppercase btn-primary mr-md-2 mr-0 mb-3 d-sm-inline d-block">Explore Popular Chalets</a> <a href="#" class="btn uppercase btn-outline-light d-sm-inline d-block">Download Brochures</a></p>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 visit mb-3" data-aos="fade-right" data-aos-delay="200">
            ...
            <h3><a href="hotel.html">View Chalet Rooms</a></h3>
            <div class="reviews-star float-left">
              <span class="ion-android-star"></span>
              <span class="ion-android-star"></span>
              <span class="ion-android-star"></span>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
            <div class="media media-custom d-block mb-4">
              ...
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
                <h2 class="mt-0 mb-3"><a href="#">Five Reasons to Stay at a Villa Resort</a></h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row mb-4">
          ...
          <div class="col-md-3 mb-5">
            ...
            <form name="registration" method="post" action="Newsletter.php" class="footer-newsletter">
              <div class="form-group">
                <input type="text" name="email" value="" class="form-control" placeholder="Your email...">
                <button type="submit" name="submit" value="submit" class="btn"><span class="fa fa-paper-plane"></span></button>
              </div>
            </form>
          </div>
        </div>
